import { App, createApp, h, Ref, ref, Directive as VueDirective, DirectiveBinding } from 'vue'
import TooltipDirective from '../components/TooltipDirective.vue'
import { getDefaultConfig } from '../config'
import { Placement, placements } from '../util/popper'
 ...
 */
export function getPlacement(options: any, modifiers: DirectiveModifiers): Placement {
...
export function getOptions(el: any, value: any, modifiers: DirectiveModifiers) {
  let options
...
function ensureDirectiveApp() {
  ...
  directiveApp = createApp({
    ...
    render() {
      // TODO: Directive type
      return this.directives.map((directive: any) => {
...
export function createTooltip(el: any, value: any, modifiers: DirectiveModifiers) {
  ensureDirectiveApp()
...
export function destroyTooltip(el: any) {
  if (el.$_popper) {
...
export function bind(el: any, { value, modifiers }: DirectiveBinding) {
...
const vTooltipDirective: VueDirective = {
  beforeMount: bind,
  updated: bind,
  beforeUnmount(el) {
    destroyTooltip(el)
...
export default vTooltipDirective;
