...
<template>
    <div class="multi-value" :class="props.classes?.multiValue">
        ...
        <button type="button" class="multi-value-remove" :class="props.classes?.multiValueRemove"
            :aria-label="`Remove ${props.label}`" @click.stop="emit('remove')">
            <XMarkIcon />
        </button>
    </div>
</template>
