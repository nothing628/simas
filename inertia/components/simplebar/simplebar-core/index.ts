...
export default class SimpleBarCore {
  ...
  positionScrollbar(axis: Axis = 'y') {
    ...
    scrollOffset =
      axis === 'x' && this.isRtl && SimpleBarCore.getRtlHelpers()?.isScrollOriginAtZero
        ? -scrollOffset
        : scrollOffset
    ...
    handleOffset =
      axis === 'x' && this.isRtl ? -handleOffset + (trackSize - scrollbar.size) : handleOffset
...
export class SimpleBar extends SimpleBarCore {
